...
pdf(height = 6, width = 4.5, file = file.fx("FigS7_short_forec.pdf"))

# windows(height = 6, width = 4.5)
# quartz(height = 6, width = 4.5)
par(mfrow = c(4,1), mar = c(0,5,0,1), las = 1, oma = c(5,2,4,1))
for (k in 1:length(f.list)) {
  ...
  plot(
    ILIpS ~ t, data = data,
    ylim = c(0, 310), xlim = t.lim,
    ylab = "", type = "l", xaxt = "n", yaxt = "n", ann = F
  )
  axis(2, at = seq(0, 1000, 100), labels = seq(0, 1000, 100)/1e4)
